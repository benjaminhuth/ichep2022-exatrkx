...
../../run_datagen.sh reconstruct . 10 --digi=truth --select --overwrite_config='{ "embeddingDim": 12 }' --with_ckf --with_truthtracking
...
../../run_datagen.sh reconstruct . 10 --digi=truth --select --overwrite_config='{ "embeddingDim": 12 }'
